...
TRANSLATIONS = {
    'en': {
        ...
        'discogs_not_configured': 'Discogs is not configured. Set DISCOGS_TOKEN or DISCOGS_CONSUMER_KEY/SECRET.',
    ...
    'pt-BR': {
        ...
        'discogs_not_configured': 'Discogs não configurado. Defina DISCOGS_TOKEN ou DISCOGS_CONSUMER_KEY/SECRET.',
