...
JS_KEYS = [
    ...
    'err_invalid_data', 'msg_product_deleted', 'msg_added_to_cart', 'msg_cart_cleared',
    'enter_valid_name_price', 'clear_cart_confirm', 'invalid', 'delete_product_confirm',
    'select_at_least_one', 'delete_products_confirm', 'cart_empty', 'carrinho', 'produtos_selecionados',
